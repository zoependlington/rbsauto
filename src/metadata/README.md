 ...
 * [pizza.yml](pizza.yml)
     * Determines how your purl.obolibrary.org/obo/pizza/ redirects will be handled
     ...
     * Paste in the contents of [pizza.yml](pizza.yml)
 ...
 * [pizza.md](pizza.md)
     ...
     * Paste in the contents of [pizza.md](pizza.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
